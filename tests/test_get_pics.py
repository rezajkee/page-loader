...
def test_get_pics():
    with tempfile.TemporaryDirectory() as tmpdirname:
        copyed_html = shutil.copy(
            "/home/rezajkee/study/projects/python-project-lvl3/tests/fixtures/hexlet.html",  # noqa: E501
            tmpdirname,
        )
        with requests_mock.Mocker() as m:
            ...
            assert os.path.isfile(
                os.path.join(
                    dir_abs_path, "ru-hexlet-io-assets-professions-nodejs.png"
                )
            )
            with open(copyed_html, "r") as f:
                with open(
                    "/home/rezajkee/study/projects/python-project-lvl3/tests/fixtures/hexlet_pic.html",  # noqa: E501
                    "r",
                ) as r:
